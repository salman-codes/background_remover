...
def __save_image_file__(img, file_name, output_path, wmode):
    """
    Saves the PIL image
    :required parameter img: PIL image
    :required parameter file_name: File name
    :required parameter output_path: Output path
    :required parameter wmode: Work mode
    """
...
def process(input_path, output_path, model_name="u2net",
    ...
    """
    Processes the file.
    :required parameter input_path: The path to the image / folder with the images to be processed.
    :required parameter output_path: The path to the save location.
    :param model_name: Model to use.
    :optional parameter postprocessing_method_name: Method for image preprocessing
    :optional parameter preprocessing_method_name: Method for image post-processing
    """
